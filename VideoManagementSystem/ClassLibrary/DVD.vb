...
#Region "Protected Data Access Methods:"
    ...
    Protected Sub DataPortal_Fetch(ByVal Key As String)
        ...
        Try
            ...
            ' Create SQL string 
            Dim strSQL As String = "SELECT * FROM DVDData WHERE IDNumber = ?"
            ...
            If objDR.HasRows Then
                ...
                Me.Category = CType(System.Enum.Parse(GetType(MovieCategory), CStr(objDR.Item(8))), MovieCategory)
                Me.Format = CType(System.Enum.Parse(GetType(DVDFormat), CStr(objDR.Item(9))), DVDFormat)
            Else

                ' If no data is returned, throw error 
                Throw New System.ApplicationException("Load Error! DVD Not Found")
            End If
    ...
    Protected Sub DataPortal_Update()
        ...
        Try
            ...
            Dim strSQL As String = "UPDATE DVDData SET Title = ?, Description = ?, Rating = ?," _
                                   & "Available = ?, SalePrice = ?, RentalRate = ?, LateFee = ?," _
                                   & "MovieCategory = ?, DVDFormat = ? WHERE IDNumber= ?"
            ...
            objCmd.Parameters.Add("@MovieCategory", OleDbType.VarChar).Value = Me.Category
            objCmd.Parameters.Add("@DVDFormat", OleDbType.VarChar).Value = Me.Format
    ...
    Protected Sub DataPortal_Insert()
        ...
        Try
            ...
            Dim strSQL As String = "INSERT INTO DVDData VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
    ...
    Protected Sub DataPortal_Delete(ByVal Key As String)
        ...
        Try
            ...
            Dim strSQL As String = "DELETE FROM DVDData WHERE IDNumber = ?"
